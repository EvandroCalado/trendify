export const CartSummarySkeleton = () => {
  return (
    <div className="flex flex-col gap-7">
      <div className="h-[20px] w-[180px] animate-pulse rounded-lg bg-zinc-200" />
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex items-center justify-between">
          <div className="h-[10px] w-[100px] animate-pulse rounded-lg bg-zinc-200" />
          <div className="h-[10px] w-[30px] animate-pulse rounded-lg bg-zinc-200" />
        </div>
      </div>

      <div className="flex items-center justify-between">
        <div className="h-[20px] w-[60px] animate-pulse rounded-lg bg-zinc-200" />
        <div className="h-[20px] w-[60px] animate-pulse rounded-lg bg-zinc-200" />
      </div>
